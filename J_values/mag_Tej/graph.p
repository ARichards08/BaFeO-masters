...
f(x)= a + b*x + c*x**2
a=1;b=1;c=1
fit f(x) 'mag_Tej.txt' u 1:2 via a, b, c
a=1;b=1;c=1
fit f(x) 'mag_Tej.txt' u 1:3 via a, b, c
a=1;b=1;c=1
fit f(x) 'mag_Tej.txt' u 1:4 via a, b, c
a=1;b=1;c=1
fit f(x) 'mag_Tej.txt' u 1:5 via a, b, c
a=1;b=1;c=1
fit f(x) 'mag_Tej.txt' u 1:6 via a, b, c
#--------------------------------------------
# Plot graph with fit
